...
vi.mock('next-intl', () => ({
  useTranslations: () => (key: string) => {
    const translations: Record<string, string> = {
      ...
      'buttons.close': 'Close',
      'footer.copyright': '© {year} PromtWork. All rights reserved.',
...
describe('Layout Property Tests', () => {
   ...
   * SHALL contain the brand name "PromtWork" in the header or title area.
   */
  describe('Property 2: Brand Consistency', () => {
    it('Header component displays PromtWork brand name for all locales', () => {
      fc.assert(
        fc.property(
          ...
          (locale) => {
            ...
            expect(brandElement.textContent).toBe('PromtWork');
    ...
    it('Footer component displays PromtWork brand name for all locales', () => {
      fc.assert(
        fc.property(
          fc.constantFrom(...locales),
          (locale) => {
      ...
      fc.assert(
        fc.property(
          ...
          (locale) => {
            ...
            expect(headerBrandText).toBe('PromtWork');
      ...
      fc.assert(
        fc.property(
          ...
          (invalidLocale) => {
            ...
            localStorage.setItem('PromtWork-language-preference', invalidLocale);
